...
export default function Home() {
  return (
    <>
      {/* Hero Section */}
      {/* <section className="min-h-[765px] mt-20 text-black px-6 py-24 bg-cover bg-bottom bg-no-repeat"
        style={{ backgroundImage: `url(${hero})` }}>
        <div className="max-w-[1140px] mt-12 mx-auto grid grid-cols-2 items-start gap-10">
          <div>
            <p className="text-4xl md:text-base text-[#231f20] font-normal">WE ARE CREATIVE</p>
            <h2 className="text-4xl md:text-6xl text-[#231f20] font-semibold mb-3 leading-tight">Let Us Boost Your Business</h2>
            <p className="text-lg md:text-[17px] text-[#231f20] leading-relaxed mb-8">
              Our focus is on innovation, performance, and excellence. So, with us by your side, your business will undoubtedly grow. We are creative and dedicated professionals offering all-round digital solutions from design and development to SEO, advertisement, and content generation.
            </p>
            <div className="space-x-4">
              <Link to="/">
                <button className="lato-font bg-[#231f20] text-white cursor-pointer text-[15px] px-10 py-5 font-semibold rounded-l-full rounded-r-full shadow hover:opacity-90 transition duration-300">
                  GET STARTED
                </button>
              </Link>
            </div>
          ...
          <div className="pl-5">
            <a href="" target="_blank">
              <img src={Banner} className="w-[522px] h-[403px] " alt="Vite logo" />
            </a>
          </div>
        </div>
      </section> */}
...
>
  ...
  <div className="absolute inset-x-0 -top-20 flex justify-center">
    <div className="relative bg-[#231f20] shadow-xl rounded-2xl w-[95%] sm:w-[90%] max-w-[1140px] grid grid-cols-2 md:grid-cols-4 text-center overflow-hidden">
      ...
      <div className="hidden md:block absolute top-1/2 left-1/4 transform -translate-y-1/2 w-[1px] h-[40%] bg-white"></div>
      <div className="hidden md:block absolute top-1/2 left-1/2 transform -translate-y-1/2 w-[1px] h-[40%] bg-white"></div>
      <div className="hidden md:block absolute top-1/2 left-[75%] transform -translate-y-1/2 w-[1px] h-[40%] bg-white"></div>
      ...
      <section className="w-full bg-white py-10 mt-[300px] md:mt-20">
      ...
      <section className="bg-white mb-20 md:mb-0 py-8 px-6">
  <div className="max-w-[1140px] mx-auto grid grid-cols-1 md:grid-cols-2 items-center gap-12 relative">
    ...
    <div className="relative flex justify-center md:justify-center mt-10 md:mt-0">
      <div className="relative">
        {/* Main image */}
        <div className="relative w-[235px] sm:w-[300px] md:w-[320px] lg:w-[406px] h-auto xl:overflow-hidden xl:origin-top-right xl:transition-all xl:duration-[7000ms] xl:ease-[cubic-bezier(0.45,0,0.15,1)] xl:hover:scale-[1.05] z-20">
          <img
            src={gallery1}
            alt="Main visual"
            className="w-full h-auto object-cover relative z-20 shadow-lg xl:transform xl:transition-transform xl:duration-[5000ms] xl:ease-in-out xl:origin-center xl:hover:scale-[1.1]"
          />
        </div>

        {/* Bottom-left Triangle */}
        <div className="absolute -bottom-8 sm:-bottom-10 -left-8 sm:-left-10 rotate-180 w-32 sm:w-36 md:w-40 h-32 sm:h-40 md:h-44 border-l-[120px] sm:border-l-[160px] md:border-l-[180px] border-l-transparent border-t-[120px] sm:border-t-[160px] md:border-t-[180px] border-t-[#1b75bb] z-10"></div>

        {/* Small overlapping image */}
        <div className="absolute bottom-[-80px] sm:bottom-[-100px] right-[-60px] sm:right-[-80px] md:right-[-40px] border-8 sm:border-10 border-white z-30">
          <img
            src={gallery2}
            alt="Small visual"
            className="w-[130px] sm:w-[220px] h-auto object-cover z-30 xl:transition-all xl:duration-[7000ms] xl:ease-[cubic-bezier(0.45,0,0.15,1)] xl:hover:scale-[1.1] xl:origin-center"
          />
        </div>

        {/* Top-right small square */}
        <div className="absolute top-0 -right-4 sm:-right-6 w-[16px] sm:w-[20px] md:w-[24px] h-[16px] sm:h-[20px] md:h-[24px] bg-[#1b75bb] z-10 border-l-2 border-white"></div>

        {/* Tiny diagonal square */}
        <div className="absolute -top-3 sm:-top-4 -right-8 sm:-right-10 w-[10px] sm:w-[12px] h-[10px] sm:h-[12px] bg-[#1b75bb] z-20"></div>
      </div>
    </div>
      ...
      <section
  className="w-full bg-white py-10 mt-[300px] md:mt-8 bg-no-repeat bg-cover bg-center"
...
>
  <div className="max-w-[1140px] mx-auto text-center px-4 sm:px-6 md:px-8">
    ...
    <div className="mt-6">
      ...
      <section className="w-full bg-white py-10 md:mt-16">
        <div className="max-w-[1140px] mx-auto text-center">
          {/* Small blue heading with horizontal lines */}
          <div className="flex items-center justify-center mb-4">
            <span className="w-12 h-[3px] bg-[#1b75bb] mr-3 rounded-full"></span>
      ...
      <section className="w-full bg-white py-10 md:mt-12 bg-fill bg-no-repeat"
        ...
        <div className="max-w-[1140px] mx-auto text-center">
          ...
          <div className="md:place-items-center">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
              {/* Card 1 */}
              <div className="flex flex-col items-center justify-center bg-white rounded-lg shadow-[0_0_16px_rgba(0,0,0,0.4)] p-4 w-[187px] h-[158px]">
                <img
                  src={W1}
                  alt="High Quality"
                  className="w-12 h-12 mb-4"
                />
                <h3 className="text-lg font-semibold text-[#221e1f]">High Quality</h3>
              </div>
              ...
              <div className="flex flex-col items-center justify-center bg-white rounded-lg shadow-[0_0_16px_rgba(0,0,0,0.4)] p-4 w-[187px] h-[158px]">
                <img
                  ...
                  className="w-12 h-12 mb-4"
                />
                <h3 className="text-lg font-semibold text-[#221e1f]">Affordable Cost</h3>
              </div>
              ...
              <div className="flex flex-col items-center justify-center bg-white rounded-lg shadow-[0_0_16px_rgba(0,0,0,0.4)] p-4 w-[187px] h-[158px]">
                <img
                  ...
                  className="w-12 h-12 mb-4"
                />
                <h3 className="text-lg font-semibold text-[#221e1f]">Clean Code</h3>
              </div>
              ...
              <div className="flex flex-col items-center justify-center bg-white rounded-lg shadow-[0_0_16px_rgba(0,0,0,0.4)] p-4 w-[187px] h-[158px]">
                <img
                  ...
                  className="w-12 h-12 mb-4"
                />
                <h3 className="text-lg font-semibold text-[#221e1f]">Friendly Support</h3>
              </div>
            </div>
      ...
      <section className="w-full h-[137.19px] md:mt-8 bg-cover bg-center bg-no-repeat place-content-center"
        style={{ backgroundImage: `url(${BG_CTA})` }}>
        <div className="max-w-[1140px] mx-auto px-6 flex flex-col md:flex-row items-center justify-between text-white text-center md:text-left gap-6">
          {/* Text content */}
          <div>
            <h2 className="text-2xl md:text-[36px] font-bold mb-2">
          ...
          {/* Button */}
          <div>
            <button className="bg-white text-[#221e1f] uppercase px-8 py-3 md:px-10 md:py-4 rounded-full font-medium shadow-lg hover:bg-[#231f20] hover:text-white transition-all duration-300">
              Get a quote
            </button>
          </div>
        </div>
