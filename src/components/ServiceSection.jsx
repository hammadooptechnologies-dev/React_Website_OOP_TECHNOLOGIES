...
//   FaCircleNotch
// } from "react-icons/fa";
// import { FaUser, FaNetworkWired, FaRegThumbsUp, FaCode, FaLock } from "react-icons/fa";
// import { FaPager, FaClock, FaHands } from "react-icons/fa";
// import { IoSettingsSharp } from "react-icons/io5";
// import { FaListAlt, FaShoppingBasket, FaExternalLinkSquareAlt, FaClipboardList } from "react-icons/fa";
...
//   const hasLeft = left && left.type; // ✅ check if left block exists

//   const layoutClass = !hasLeft
//     ? "md:grid-cols-1" // only right block → full width
//     : layout === "50_50"
//       ? "md:grid-cols-[50%_50%]"
//       : "md:grid-cols-[55%_45%]";

//   return (
//     <section className="bg-white mb-10 md:mb-0 py-12 px-6">
//       <div
//         className={`max-w-[1140px] mx-auto grid grid-cols-1 ${layoutClass} items-start gap-4 relative`}
//       >
//         {/* LEFT BLOCK */}
//         {left && left.type && (
...
//       {section.layout === "with-heading" && section.blocks && (
//         <div className={`${section.headingPx || "px-6"} w-full`}>
//           {/* Main Heading and Paragraph */}
//           <div
//             className={`max-w-[900px] mx-auto mb-10 text-${section.headingAlign || "left"}`}
//           >
//             {section.mainHeading && (
...
//               <div
//                 key={i}
//                 className={`grid grid-cols-1 md:grid-cols-2 gap-10 items-center ${block.imagePosition === "right" ? "md:flex-row-reverse" : ""
//                   }`}
//               >
//                 {/* Image */}
...
//                     src={block.image}
//                     alt={block.heading || ""}
//                     className="rounded-lg shadow-md hover:scale-105 transition-transform duration-500 object-contain w-full h-auto max-h-[400px]"
//                   />
//                 </div>
  ...
  {section.icons && (
    <div className=" grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-x-60 gap-y-20 text-center mt-10">
      {section.icons.map((iconItem, idx) => (
        ...
        >
          <div
            className={`flex items-center justify-center ${iconItem.iconDivClass || "rounded-full bg-[#e6f1fa] w-[80px] h-[80px]"}`}
          >
            <div
