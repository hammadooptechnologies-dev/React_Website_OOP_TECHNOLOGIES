...
export default function NeedHelpPanel() {
  ...
  return (
    ...
    >
      ...
      <div
        className={`bg-[#1b75bb] text-white w-[291px] h-56 p-5 shadow-xl flex flex-col justify-center gap-3 transition-all duration-500 ${isOpen ? "opacity-100 visible" : "opacity-100 visible"
          }`}
      >
      ...
      <button
        ...
        className="bg-[#231f20] text-white font-semibold rounded-r-xl shadow-lg
             transition-all duration-300 flex flex-col items-center justify-center w-[60px] h-56 gap-16 pt-4"
      >
        {/* --- Logo Image --- */}
        <img
